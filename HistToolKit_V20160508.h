...
int DrawSingleHistOnCanvas(string canvasname, TH1F* hist, bool DrawHistorNot=false, bool logx=false, bool logy=true, bool isrectangle=true)
{
...
int DrawTwoHistsOnCanvas(string canvasname, TH1F* hist1, TH1F* hist2, bool FirstDrawHistorNot=false, bool SecondDrawHistorNot=true, bool logx=false, bool logy=true, bool isrectangle=true)
{
  gStyle->SetOptTitle(0); //this will disable the title for all coming histograms
  // define Canvas
  float height=600 ;
...
int DrawThreeHistsOnCanvas(string canvasname, TH1F* hist1, TH1F* hist2, TH1F* hist3, bool FirstDrawHistorNot=false, bool SecondDrawHistorNot=false, bool ThirdDrawHistorNot=false, bool logx=false, bool logy=true, bool isrectangle=true)
{
  gStyle->SetOptTitle(0); //this will disable the title for all coming histograms
  // define Canvas
  float height=600 ;
...
int DrawFourHistsOnCanvas(string canvasname, TH1F* hist1, TH1F* hist2, TH1F* hist3, TH1F* hist4, bool FirstDrawHistorNot=false, bool SecondDrawHistorNot=false, bool ThirdDrawHistorNot=false, bool FourthDrawHistorNot=false, bool logx=false, bool logy=true, bool isrectangle=true)
{
  gStyle->SetOptTitle(0); //this will disable the title for all coming histograms
  // define Canvas
  float height=600 ;
...
int DrawTopTwoHistsAndBottomOneHistOnCanvas(string canvasname, TH1F *top1, TH1F *top2, 
